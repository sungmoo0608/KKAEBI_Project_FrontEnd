...
const GoodsFundListPage = () => {
  //http://localhost:8282/goodsrest/Fundlist
                              ...
                              <td>
                                {
                                  ...
                                  goodsItem.goods.invest_gubun === 1
                                    ? "주식형"
                                    : goodsItem.goods.invest_gubun === 2
                                    ? "채권형"
                                    : goodsItem.goods.invest_gubun === 3
                                    ? "혼합형"
                                    : "알 수 없음" // 예외 처리: 다른 값이 올 경우
                                }
                              </td>
                              <td>{goodsItem.baseprice.trbase_price}</td>
                              <td>7.0%(임의값)</td>
                              {!isAdmin && (
                                <>
                                  <td>
...
export default GoodsFundListPage;
