...
const GoodStockPricePage = () => {
  ...
  const updateGoodsPrice = () => {
    ...
    basketService
      ...
      .then((respose) => {
        console.log(respose);
        navigate(`/goods/stocklist/update/${goods.goods_code}/result`, {
          state: { goods },
        });
      })
      .catch((error) => {
                    ...
                    <div className="card h-100 bg-light">
                      <div className="card-header bg-dark text-white text-center">
                        <h4 className="text-center font-weight-light m-0 p-0">
                          <FontAwesomeIcon icon={faPencilSquare} /> 주가 변경
                          진행중입니다.
                        </h4>
                      </div>
                      <div className="card-body">
                        ...
                        <div className="input-group mb-3">
                          <span className="input-group-text">등록할 주가</span>
                          <input
                            className="form-control"
                            type="text"
...
export default GoodStockPricePage;
