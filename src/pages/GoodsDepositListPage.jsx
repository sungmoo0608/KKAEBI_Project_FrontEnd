...
const GoodsDepositListPage = () => {
  //http://localhost:8282/goodsrest/Depositlist
                        ...
                        goods
                          ...
                          .map((goodsItem) => (
                            <tr key={goodsItem.goods.goods_code}>
                              ...
                              <td>{goodsItem.interestRate.period_mm}</td>
                              <td>{goodsItem.interestRate.interest_rate}</td>
                              <td>10억주세요.</td>
                              {!isAdmin && (
                                <>
                                  <td>
...
export default GoodsDepositListPage;
