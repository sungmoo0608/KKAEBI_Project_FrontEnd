...
const TransactionStockResultPage = () => {
                  ...
                  <div className="col-xl-6 col-md-6 mb-6">
                    <div className="card h-100 bg-light">
                      ...
                      <div className="card-body">
                        ...
                        <div className="input-group mb-3">
                          <span className="input-group-text">주가</span>
                          <input
                            type="number"
                            id="curprice"
                            className="form-control"
                        ...
                        <div className="input-group mb-3">
                          <span className="input-group-text">투자 주식수</span>
                          <input
                            className="form-control"
                            type="text"
                            name="tr_number"
                            value={transaction.tr_number}
                            disabled
                          ></input>
...
export default TransactionStockResultPage;
