...
import LineChartUrlStockprice from "../components/chart/LineChartUrlStockprice";
...
const GoodsStockViewPage = () => {
  ...
  const [stockprice, setStockprice] = useState(initStockpriceState);
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="container my-3">
                        <LineChartUrlStockprice></LineChartUrlStockprice>
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      <div className="row justify-content-center">
                        <div className="col">
                          ...
                          <button
                            className="btn btn-secondary btn-block btn-sm m-1"
                            onClick={cancleClick}
                          >
                            목록 보기
                          </button>
...
export default GoodsStockViewPage;
