              ...
              <div className="card-body">
                <div className="form-group mt-3 mb-3">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="1001">상품코드수정예정1001</option>
                    <option value="1002">상품코드수정예정1002</option>
                    <option value="1003">상품코드수정예정1003</option>
                  </select>
                </div>
                ...
                <div className="form-group mt-3 mb-3">
                  <label> 후기 노출 상태 </label>
                  <select
                    placeholder="후기 노출 상태를 선택하세요."
                    className="form-control"
                    name="status"
                    value={review.status}
                    onChange={handleInputChange}
                ...
                <div className="form-group mt-3 mb-3">
                  <label> 후기 등록일 선택 </label>
                  <input
                    type="date"
                    placeholder="후기 등록일 선택을 선택하세요."
                    name="regist_date"
                    className="form-control"
                ...
                <div className="form-group mt-3 mb-3">
                  <label> 후기 해제 일자 </label>
                  <input
                    type="date"
                    placeholder="후기 해제 일자를 선택하세요."
                    name="expire_date"
                    className="form-control"
...
export default ZMReviewWritePage;
