...
const GoodsDepositPricePage = () => {
  ...
  const getGoodsGubun = () => {
    switch (location.pathname) {
      case "/goods/depositlist":
        return 1;
      case "/goods/fundlist":
        return 2;
      case "/goods/exlist":
        return 3;
      case "/goods/stocklist":
        return 4;
      default:
        return 1; //기본값
    }
  ...
  const updateGoodsPrice = () => {
    ...
    basketService
      ...
      .then((respose) => {
        console.log(respose);
        navigate(`/goods/depositlist/update/${goods.goods_code}/result`, {
          state: { goods },
        });
      })
      .catch((error) => {
                    ...
                    <div className="card h-100 bg-light">
                      <div className="card-header bg-dark text-white text-center">
                        <h4 className="text-center font-weight-light m-0 p-0">
                          ...
                          {goods.goods_name} 금리 등록/변경 진행중입니다.
                        </h4>
                      </div>
                      <div className="card-body">
                        ...
                        <div className="input-group mb-3">
                          <span className="input-group-text">예치 기간</span>
                          <input
                            className="form-control"
                            type="text"
                        ...
                        <div className="input-group mb-3">
                          <span className="input-group-text">등록할 금리</span>
                          <input
                            className="form-control"
                            type="text"
...
export default GoodsDepositPricePage;
